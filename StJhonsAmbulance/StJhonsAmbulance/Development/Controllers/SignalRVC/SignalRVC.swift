...
class SignalRVC: UIViewController {
...
//
//    public init(url: URL) {
//        connection = HubConnectionBuilder(url: url).withLogging(minLogLevel: .error).withHttpConnectionOptions(configureHttpOptions: { httpConnectionOptions in
//            httpConnectionOptions.skipNegotiation = true
////            httpConnectionOptions.accessTokenProvider
//        }) .build()
//
////        createReconnectableHttpConnection
